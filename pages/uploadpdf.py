...
openai_mm_llm = OpenAIMultiModal(
    model="gpt-4-vision-preview", api_key=st.secrets["OPENAI_API_KEY"], max_new_tokens=3000
)
...
if imageupload is not None:
    ...
    image_documents = [
        ImageDocument(image_path=os.path.join("data/pages/",image_path)) for image_path in dirs
    ]
